...
export const MALAISIE: CountryProfile = {
  id: "malaisie",
  slug: "malaisie",
  ...
  languages: ["Malais"],
  currency: "Ringgit",
  government: "Monarchie constitutionnelle fédérale élective",
  ...
  keyActors: [{ name: "Gouvernement de Malaisie", type: "Government", country: "Malaisie", role: "Exécutif" }],
  relatedEvents: [],
  sources: [
    { id: "malaisie-demo-1", title: "Exemple de source institutionnelle (placeholder)", type: "institutional", accessedAt: "2026-09-26", reliability: 3, notes: "Source fictive — à remplacer." },
  ],
